...
def factors():
    ...
    summaries = ['Заметим: чем больше зелени, тем благополучнее район.',
                 ...
                 'Наличие в микрорайоне школы - неотъемлемая часть благополучной жизни. Высокий уровень '
                 ...
                 'района.',
                 'Наличие в микрорайоне детского садика - неотъемлемая часть благополучной жизни. Высокий уровень '
                 ...
                 ' Хотя у последнего среднее значение ниже, чем у первых двух, но зато у ЦАО наибольший разброс '
    ...
    st.text('Заметим следующие любопытные зависимости:\n'
            'Высокий уровень зелени почти всегда идет вместе с наличием в микрорайоне водоема. '
            ...
            'заметно, что супермаркеты и ТЦ располагаются вдоль оживленных магистралей.\n'
